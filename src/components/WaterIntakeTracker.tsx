...
export function WaterIntakeTracker({ defaultGoal = 64 }: WaterIntakeTrackerProps) {
  const [goal] = useState(defaultGoal); // Fixed at 64oz for the 8x8 rule
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
      ...
      <div className="relative h-48 w-24 mx-auto mb-6">
        {/* Bottle neck */}
      ...
      <div className="grid grid-cols-3 gap-2 mb-4">
        {[8, 16, 24].map(amount => (
          <button
            ...
            className="px-2 py-1 text-sm bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-300 rounded-md hover:bg-blue-100 dark:hover:bg-blue-900/50 transition-colors"
          >
            +{amount}oz
          </button>
        ))}
